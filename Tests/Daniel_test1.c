...
//NOTE: Daniel's system tests dont follow the spec. The system
// task never yields or terminates so, it stays stuck at the first S1
// after returning Recv. Added yield to keep the spirit of the test
